...
public class Rectangle {
  ...
  public boolean intersects(final Rectangle rectangle) {
    ArrayList<Point> cornersOfCurrentRectangle = new ArrayList<>();
    cornersOfCurrentRectangle.add(new Point(x,y));
    cornersOfCurrentRectangle.add(new Point(x+width,y));
    cornersOfCurrentRectangle.add(new Point(x,y + height));
    cornersOfCurrentRectangle.add(new Point(x + width ,y + height));
